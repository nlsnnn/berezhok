  ...
  return (
    <PartnerLayout title="Чаты" subtitle="Сообщения с клиентами по заказам">
      <div className="overflow-hidden rounded-2xl border border-cream-200 bg-white shadow-sm">
        <div className="grid h-[calc(100svh-230px)] min-h-0 overflow-hidden lg:grid-cols-[360px_minmax(0,1fr)]">
...
function MessageBubble({ message }) {
  ...
  return (
    <div className={cn('flex', isMine ? 'justify-end' : 'justify-start')}>
      <div
        className={cn(
          'min-w-0 max-w-[85%] overflow-hidden rounded-2xl px-4 py-2 text-sm shadow-sm md:max-w-[70%]',
